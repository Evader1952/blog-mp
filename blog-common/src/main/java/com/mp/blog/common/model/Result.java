...
public class Result<T>{
    ...
    public static Result fail(String error_code, String error_msg) {
        Result model = new Result();
    ...
    public static Result expired(String error_code, String error_msg) {
        Result model = new Result();
    ...
    public static Result error(String error_code, String error_msg) {
        Result model = new Result();
